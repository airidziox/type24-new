const chooseTamagotchiScreen = document.querySelector(".chooseTamagotchi") as HTMLDivElement;
const gameScreen = document.querySelector(".gameScreen") as HTMLDivElement;
const gameOverScreen = document.querySelector(".gameOverScreen") as HTMLDivElement;
const tamagotchiImg = document.querySelectorAll(".tamagotchiImg") as NodeListOf <HTMLImageElement>;
const chosenTamagotchiImg = document.querySelector(".chosenTamagotchi") as HTMLImageElement;
const poopsOnScreen = document.querySelector(".poops") as HTMLDivElement;
const playAgain = document.querySelector(".playAgain") as HTMLButtonElement;
const option = document.querySelectorAll(".option") as NodeListOf <HTMLDivElement>;

const happyBar = document.querySelector(".happyBar") as HTMLDivElement;
const foodBar = document.querySelector(".foodBar") as HTMLDivElement;
const sleepBar = document.querySelector(".sleepBar") as HTMLDivElement;

gameScreen.style.display = "none";

let happy:number = 100
let food:number = 100
let sleep:number = 100
